-- ==============================================
-- File: Performance Analysis.sql
-- Purpose: Analyze product performance by comparing current sales 
--          against historical averages and previous periods.
-- ==============================================

-- ------------------------------------------
-- 1. Yearly Product Performance
-- ------------------------------------------
-- Utilizes Window Functions to calculate averages and prior-year comparisons.
...
-- ------------------------------------------
-- Aggregates metrics by month to identify seasonal trends and short-term growth.
WITH yearly_product_sales AS (
SELECT
